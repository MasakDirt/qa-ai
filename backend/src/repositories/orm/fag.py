...
from backend.src.utils.interfaces.repository import OrmRepositoryInterface
from backend.src.utils.types.transform_types import FAQTransformAllCallback, FAQTransformCallback
